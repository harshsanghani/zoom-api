...
class ZoomAPI{
	...
	private $api_key = 'JiFmR-t3SRa-ewP1vq5GsaHg';
	private $api_secret = 'NG0ugqywSeT4wvNzzZCasda8p70TXpu2n91pwfkn';
...
//	  $createAMeetingArray['start_time'] = $data['start_time'];
//	  $createAMeetingArray['type'] = $data['meetingType'];
	  return $this->sendRequest('meeting/create', $data);
	}
...
//	  $listMeetingsArray['host_id'] = $_POST['userId'];
	  return $this->sendRequest('meeting/list',$data);
	}
